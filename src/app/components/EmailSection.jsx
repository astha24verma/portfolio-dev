    ...
    >
      <div>
        ...
        <div className="socials flex flex-row justify-evenly md:justify-center lg:mr-64">
          <Link
            href="https://github.com/astha24verma"
            className="h-15 w-15 md:h-20 md:w-20 hover:scale-125 active:scale-105 duration-200"
          >
            <Image src={GithubIcon} alt="GitHub Icon" />
          </Link>
          <Link
            href="https://www.linkedin.com/in/astha-verma-21a6ba1ab/"
            className="h-15 w-15 md:h-20 md:w-20 hover:scale-125 active:scale-105 duration-200"
          >
            <Image src={LinkedinIcon} alt="Linkedin Icon" />
          </Link>
          <Link
            href="https://x.com/astha_verma_"
            className="h-15 w-15 md:h-20 md:w-20 hover:scale-125 active:scale-105 duration-200"
          >
            <Image src={TwitterIcon} alt="Twitter Icon" />
          </Link>
          <Link
            href="https://www.instagram.com/astha24verma/"
            className="h-15 w-15 md:h-20 md:w-20 hover:scale-125 active:scale-105 duration-200"
          >
      ...
      <div>
        ...
        >
          ...
          <input
            type="hidden"
            name="subject"
            value="(IMP) Portfolio connection for Astha"
          />
